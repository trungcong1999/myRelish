				...
				<div class="box box-primary">
					...
					<form:form action="${pageContext.request.contextPath}/admin/pages/game/editGame" modelAttribute="editGame" method="POST">
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label>Tên Game</label> <form:input path="name" class="form-control" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Điểm đánh giá </label> <form:input path="metacritic_score" class="form-control"/>
							</div>
							<div class="form-group">
								<label for="Category">Người đăng</label>
								<div class="form-group">
									<form:select path="publisher_id" class="form-control">
										<c:forEach items="${listGame}" var="game">
										<form:option value="${game.publisher_id}">${game.user_name}</form:option>
										</c:forEach>
									</form:select>
								</div>
							</div>
							<div class="form-group">
								<label for="Category">Người phát triển</label>
								<div class="form-group">
									<form:select path="developer_id" class="form-control">
										<c:forEach items="${listGame}" var="game">
										<form:option value="${game.publisher_id}">${game.user_name}</form:option>
										</c:forEach>
									</form:select>
