		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="box box-primary">
					...
					<!-- /.box-header -->
					<!-- form start -->
					<form:form action="${pageContext.request.contextPath}/admin/pages/novel/editNovel" modelAttribute="editNovel" method="POST">
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label>Tên tiểu thuyết</label> <form:input path="name" class="form-control" />
							</div>
							<div class="form-group">
								<label>Ảnh</label> <input name="cover_img"
							...
							<div class="form-group">
								...
								<div class="form-group">
									<form:select path="author_id" class="form-control">
										<c:forEach items="${listNovel}" var="creators">
										<form:option value="${creators.author_id}">${creators.authorNovel}</form:option>
										</c:forEach>
									</form:select>
								</div>
							</div>
