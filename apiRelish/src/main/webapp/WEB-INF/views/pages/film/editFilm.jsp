				...
				<div class="box box-primary">
					...
					<form:form action="${pageContext.request.contextPath}/pages/film/editFilm" modelAttribute="editFilm" method="POST">
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label>Tên Phim</label> <form:input path="name" class="form-control" />
							</div>
							<div class="form-group">
								<label>Chi tiết</label>
								<form:textarea path="description" style="height: 200px;"  class="form-control" />
							</div>

							<div class="form-group">
								<label for="Category">Người Viết</label>
								<div class="form-group">
									<form:select path="writer_id" class="form-control">
										<c:forEach items="${listFilm}" var="film">
										<form:option value="${film.writer_id}">${film.name_creator}</form:option>
										</c:forEach>
									</form:select>
								</div>
							</div>
							<div class="form-group">
								<label for="Category">Người Sáng tác</label>
								<div class="form-group">
									<form:select path="director_id" class="form-control">
										<c:forEach items="${listFilm}" var="film">
										<form:option value="${film.director_id}">${film.name_creator}</form:option>
										</c:forEach>
									</form:select>
								</div>
							</div>
							...
							<div class="form-group">
								<label for="exampleInputFile">Ảnh đại diện</label> <input name="poster_img"
