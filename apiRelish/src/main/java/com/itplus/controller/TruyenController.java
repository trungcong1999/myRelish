...
public class TruyenController {
	...
	@RequestMapping(value = "/admin/pages/novel/list", method = RequestMethod.GET)
	...
	// thêm Truyện
	@RequestMapping(value = "/admin/pages/novel/addNovel",method = RequestMethod.GET)
			public String showAddTruyen(Model model,HttpServletRequest request) {
				Truyen truyen = new Truyen();
				List<Creator> creators = truyenService.getAllCreator(); 
	...
	@RequestMapping(value = "/admin/pages/novel/addNovel", method = RequestMethod.POST)
	public String AddNovel(@ModelAttribute("addNovel") Truyen truyen, @RequestParam String name,
			@RequestParam String author_id, @RequestParam String description, @RequestParam String cover_img,
	...
	@RequestMapping(value = "/admin/pages/novel/editNovel/{id}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/admin/pages/novel/editNovel", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/admin/pages/novel/delete/{id}", method = RequestMethod.GET)
